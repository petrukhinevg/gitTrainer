...
class SessionControllerCliWorkingDirectoryPolicyTest {
    ...
    SessionControllerCliWorkingDirectoryPolicyTest(WebApplicationContext webApplicationContext) {
    ...
    @Test
    void returnsRetryableProblemDetailWhenWorkingDirectoryIsInvalid() throws Exception {
        ...
        mockMvc.perform(post("/api/sessions/{sessionId}/submissions", sessionId)
                ...
                .andExpect(jsonPath("$.code").value("validation-runner-invalid-working-directory"))

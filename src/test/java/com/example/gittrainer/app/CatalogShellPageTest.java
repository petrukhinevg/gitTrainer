...
class CatalogShellPageTest {
    ...
    void servesCatalogShellFromRoot() throws Exception {
        ...
        mockMvc.perform(get("/app.js"))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Git branch view and command input")))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Git branch view")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Git branch picture")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("A fixed branch picture stays visible above the input field.")))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("The answer field unlocks after you open a task.")))

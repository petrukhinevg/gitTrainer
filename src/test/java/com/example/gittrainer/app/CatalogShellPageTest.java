...
class CatalogShellPageTest {
    ...
    void servesCatalogShellFromRoot() throws Exception {
        ...
        mockMvc.perform(get("/app.js"))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Submit answer")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Session transport")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Submission transport")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Correctness feedback")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("Unsupported answer type")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString("file_patch")))
        ...
        mockMvc.perform(get("/app.css"))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString(".lesson-layout__lane--navigation")))
                ...
                .andExpect(content().string(org.hamcrest.Matchers.containsString(".practice-output--correct")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString(".practice-output--unsupported")))
                .andExpect(content().string(org.hamcrest.Matchers.containsString(".practice-feedback__pill")))

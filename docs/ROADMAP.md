...
- Когда backend- и frontend-работа описывают один пользовательский срез, но остаются независимо реализуемыми, держи их в одном parent issue и отражай их связь через явные ссылки в issue-текстах, roadmap и структуру `Parent issue` на доске.
